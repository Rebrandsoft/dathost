...
class ServerInfo
{
  ...
  protected function SI_Get_Server_Info()
  {
    ...
    // Debugging output for header info
    // Writing header content to log file
    $logFile = dirname(__FILE__) . '/server_info.log'; // Change this to the desired log file path
    file_put_contents($logFile, "Header: " . $header . "\n", FILE_APPEND);
