                    ...
                    <div class="rating_block">
                        ...
                        <div class="rating_player_card scroll no-scrollbar">
                            ...
                            for ($dd = 0; $dd < $count; $dd++) {
                                ...
                                <div class="rating_player_info <?php if ($dd + 1 == '1') : ?>first_place<?php endif; ?><?php if ($dd + 1 == '2') : ?>second_place<?php endif; ?><?php if ($dd + 1 == '3') : ?>third_place<?php endif; ?>" onclick="location.href = '<?= $General->arr_general['site'] ?>profiles/<?php print $General->arr_general['only_steam_64'] === 1 ? con_steam32to64($data_paste[$d][$dd]['steam']) : $data_paste[$d][$dd]['steam'] ?>/<?= $d ?>';">
                                    ...
                                    <div class="rating_info_right">
                                        ...
                                        <?php if ($Db->statistics_table[$d]['DB_mod'] != 'RankMeKento') : ?>
                                            <img class="rating_rank" data-src="<?= $General->arr_general['site'] . 'storage/cache/img/ranks/' . $Db->statistics_table[$d]['ranks_pack'] . '/' . $data_paste[$d][$dd]['rank'] ?>.svg" alt="" title="">
                                        <?php endif ?>
                                    </div>
                                </div>
                            <?php } ?>
                    ...
                    <div class="server_block">
                        ...
                        <div class="server_info_block">
                            ...
                            <div class="server_right_block">
                                ...
                                <button class="server_button play" id="<?= $i_server ?>" onclick="get_players_data(id)" href="javascript:void(0);" title="">
